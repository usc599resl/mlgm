...
flags.DEFINE_integer('num_classes', 1, 'number of classes used in classification (e.g. 5-way classification).')
...
def main():
    ...
    num_tasks = FLAGS.meta_batch_size
    data_generator = DataGenerator(num_samples_per_class, num_tasks)  # only use one datapoint for testing to save memory
